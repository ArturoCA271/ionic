...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Lector codigo QR\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  \n  <ion-button expand= \"full\" (click) = \"scanerCode()\" color=\"secondary\">\n    <ion-icon name=\"scannerQR\"></ion-icon>\n    Scanner QR Code\n  </ion-button>\n\n  <ion-card *ngIf= \"scannerCode\">\n    <ion-card-conten>\n      Result from Scan: {{ scannerCode }}\n    </ion-card-conten>\n  </ion-card>\n\n  <ion-button expand= \"full\" (click) = \"downloadQR()\" color=\"secondary\">\n    <ion-icon name=\"scannerQR\"></ion-icon>\n    Download QR Code\n  </ion-button>\n\n\n</ion-content>");
...
/* harmony import */ var _ionic_native_base64_to_gallery_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/base64-to-gallery/ngx */ "./node_modules/@ionic-native/base64-to-gallery/__ivy_ngcc__/ngx/index.js");
...
let Tab2Page = class Tab2Page {
    constructor(barcode, image, toastCtl) {
    ...
    downloadQR() {
        ...
        this.image.base64ToGallery(data, { prefix: '_img', mediaScanner: true })
            .then((res) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let toast = yield this.toastCtl.create({
